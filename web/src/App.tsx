...
import { CreatedBanner } from './components/CreateAdBanner';
...
function App() {
  ...
  return (
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
      ...
      <h1 className='text-6xl text-white font-black my-20'> Seu <span className='text-transparent bg-nlw-gradient bg-clip-text'> duo </span> está aqui.</h1>
